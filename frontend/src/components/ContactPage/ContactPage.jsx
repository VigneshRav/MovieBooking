...
const ContactPage = () => {
  ...
  const handleSubmit = (e) => {
    ...
    window.open(`https://wa.me/9843962513?text=${whatsappMessage}`, '_blank');
  };
                ...
                <div className={contactStyles.contactInfo}>
                  <div className={contactStyles.contactItem}>
                    ...
                    <div>
                      ...
                      <p className={contactStyles.contactDetail}>+91 9843962513</p>
                    </div>
                  </div>
                  ...
                  <div className={contactStyles.contactItem}>
                    ...
                    <div>
                      ...
                      <p className={contactStyles.contactDetail}>123 Cinema Street, Film City, Tamilnadu, FC 400001</p>
